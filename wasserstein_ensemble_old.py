...
def get_wassersteinized_layers_modularized_layer_fusion(args, networks, activations=None, eps=1e-7, test_loader=None, base_model=0, fuse_layer_start_idx):
    '''
